...
void HoudiniApi::initialize_hapi(void *library_handle)
{
	if (!library_handle)
		return;
...
bool HoudiniApi::is_hapi_initialized()
{
...
void HoudiniApi::SessionInfo_InitEmptyStub(HAPI_SessionInfo *in)
{
	return;
}
HAPI_SessionInfo
...
void HoudiniApi::ThriftServerOptions_InitEmptyStub(HAPI_ThriftServerOptions *in)
{
	return;
}
...
void HoudiniApi::TimelineOptions_InitEmptyStub(HAPI_TimelineOptions *in)
{
	return;
}
...
void HoudiniApi::CompositorOptions_InitEmptyStub(HAPI_CompositorOptions *in)
{
	return;
}
...
void HoudiniApi::AssetInfo_InitEmptyStub(HAPI_AssetInfo *in)
{
	return;
}
HAPI_AssetInfo
...
void HoudiniApi::CookOptions_InitEmptyStub(HAPI_CookOptions *in)
{
	return;
}
HAPI_CookOptions
...
void HoudiniApi::NodeInfo_InitEmptyStub(HAPI_NodeInfo *in)
{
	return;
}
HAPI_NodeInfo
...
void HoudiniApi::ParmInfo_InitEmptyStub(HAPI_ParmInfo *in)
{
	return;
}
HAPI_ParmInfo
...
int HoudiniApi::ParmInfo_GetIntValueCountEmptyStub(const HAPI_ParmInfo *in)
{
	return -1;
}
int HoudiniApi::ParmInfo_GetFloatValueCountEmptyStub(const HAPI_ParmInfo *in)
{
	return -1;
}
int HoudiniApi::ParmInfo_GetStringValueCountEmptyStub(const HAPI_ParmInfo *in)
{
	return -1;
}
void HoudiniApi::ParmChoiceInfo_InitEmptyStub(HAPI_ParmChoiceInfo *in)
{
	return;
}
HAPI_ParmChoiceInfo
...
void HoudiniApi::HandleInfo_InitEmptyStub(HAPI_HandleInfo *in)
{
	return;
}
HAPI_HandleInfo
...
void HoudiniApi::HandleBindingInfo_InitEmptyStub(HAPI_HandleBindingInfo *in)
{
	return;
}
...
void HoudiniApi::ObjectInfo_InitEmptyStub(HAPI_ObjectInfo *in)
{
	return;
}
HAPI_ObjectInfo
...
void HoudiniApi::GeoInfo_InitEmptyStub(HAPI_GeoInfo *in)
{
	return;
}
HAPI_GeoInfo
...
int HoudiniApi::GeoInfo_GetGroupCountByTypeEmptyStub(HAPI_GeoInfo *in, HAPI_GroupType type)
{
	return -1;
}
void HoudiniApi::PartInfo_InitEmptyStub(HAPI_PartInfo *in)
{
	return;
}
HAPI_PartInfo
...
int HoudiniApi::PartInfo_GetElementCountByAttributeOwnerEmptyStub(HAPI_PartInfo *in, HAPI_AttributeOwner owner)
{
	return -1;
}
int HoudiniApi::PartInfo_GetElementCountByGroupTypeEmptyStub(HAPI_PartInfo *in, HAPI_GroupType type)
{
	return -1;
}
int HoudiniApi::PartInfo_GetAttributeCountByOwnerEmptyStub(HAPI_PartInfo *in, HAPI_AttributeOwner owner)
{
	return -1;
}
void HoudiniApi::AttributeInfo_InitEmptyStub(HAPI_AttributeInfo *in)
{
	return;
}
HAPI_AttributeInfo
...
void HoudiniApi::MaterialInfo_InitEmptyStub(HAPI_MaterialInfo *in)
{
	return;
}
HAPI_MaterialInfo
...
void HoudiniApi::ImageFileFormat_InitEmptyStub(HAPI_ImageFileFormat *in)
{
	return;
}
...
void HoudiniApi::ImageInfo_InitEmptyStub(HAPI_ImageInfo *in)
{
	return;
}
HAPI_ImageInfo
...
void HoudiniApi::Keyframe_InitEmptyStub(HAPI_Keyframe *in)
{
	return;
}
HAPI_Keyframe
...
void HoudiniApi::VolumeInfo_InitEmptyStub(HAPI_VolumeInfo *in)
{
	return;
}
HAPI_VolumeInfo
...
void HoudiniApi::VolumeTileInfo_InitEmptyStub(HAPI_VolumeTileInfo *in)
{
	return;
}
HAPI_VolumeTileInfo
...
void HoudiniApi::CurveInfo_InitEmptyStub(HAPI_CurveInfo *in)
{
	return;
}
HAPI_CurveInfo
...
void HoudiniApi::InputCurveInfo_InitEmptyStub(HAPI_InputCurveInfo *in)
{
	return;
}
HAPI_InputCurveInfo
...
void HoudiniApi::Transform_InitEmptyStub(HAPI_Transform *in)
{
	return;
}
HAPI_Transform
...
void HoudiniApi::TransformEuler_InitEmptyStub(HAPI_TransformEuler *in)
{
	return;
}
HAPI_TransformEuler
...
void HoudiniApi::Viewport_InitEmptyStub(HAPI_Viewport *in)
{
	return;
}
HAPI_Viewport
...
void HoudiniApi::SessionSyncInfo_InitEmptyStub(HAPI_SessionSyncInfo *in)
{
	return;
}
